...
public class FeedBackMessage {
    ...
    /*======================== Start User API=====================================*/
    public static final String CREATE_SUCCESS = "User account created successfully";
    public static final String DELETE_SUCCESS = "User account deleted successfully";
